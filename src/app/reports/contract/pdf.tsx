...
export function ContractPdf({
  ...
  const fmtSigned = (v: string | null) => (v ? fmtDateTime(v, timezone) : "—");
  return (
    <ReportShell orgName={orgName} title="Employment contract" subtitle={staffName} timezone={timezone}>
          ...
          <View style={styles.section} wrap={false}>
            ...
            {contract.signed_at ? (
              <>
                ...
                <Text style={styles.cell}>Date: {fmtSigned(contract.signed_at)}</Text>
          ...
          <View style={styles.section} wrap={false}>
            ...
            {contract.countersigned_at ? (
              <>
                ...
                <Text style={styles.cell}>Date: {fmtSigned(contract.countersigned_at)}</Text>
